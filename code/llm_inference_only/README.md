...
This version loads pre-trained GPT-2 small weights and generates one next
token. It does not contain a training loop.
...
```bash
python code/llm_inference_only/generate.py --weights /path/to/gpt2-small.pth "The dog fetched the"
```
